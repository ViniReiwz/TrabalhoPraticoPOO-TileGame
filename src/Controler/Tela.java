...
public class Tela extends javax.swing.JFrame implements MouseListener, KeyListener {
    ...
    private MenuJogo menu = new MenuJogo();
    ...
    public Tela() {
        ...
        this.cj.setMenu(this.menu);
        
        // booleana pra saber em que direção o herói se movimentou (usa pra parede girar só quando ele se mexe na direção certa) 
        cima=false;
        baixo=false;
        direita=false;
        esquerda=false;
     ...
     // Posição inicial do inimigo
        ...
        Chaser chase2 = new Chaser("vilao1direita1.png", 20, 8);    // centro do mapa (20, 8)
    ...
    public void paint(Graphics gOld) {
        ...
        if (!this.faseAtual.getPersonagens().isEmpty()) {
            ...
            if(this.menu.InicioJogo==0){
                this.menu.desenhar(gJogo,g2, this, this.faseAtual);
            }
            else if(this.menu.InicioJogo==1){
    ...
    public void keyPressed(KeyEvent e) {
        try {
            ...
            else if (e.getKeyCode() == KeyEvent.VK_RIGHT) 
            {
                ...
                this.menu.InicioJogo=0;
                this.fases.set(0, new Fase1());
                faseAtual = this.fases.get(0);
            }
