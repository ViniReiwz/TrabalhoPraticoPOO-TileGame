    ...
    private void spawnarInimigos(Fase fase){
        ...
        if(numChasers < maxInimigos){
            ...
            if(contadorSpawn >= tempoDaFase){
                ...
                TipoVilao = "vilao" + (numChasers+1) + "direita1.png";
                
                Chaser novoInimgo = new Chaser(TipoVilao, posicaoSpawnCentral.getLinha(), posicaoSpawnCentral.getColuna());
